...
@Slf4j
public class WhatsAppConsumerUseCase {
    ...
    public void execute(StreamMessage message) {
        try {
            ...
            log.info("[{}] Received message of WhatsApp: {}", this.getClass().getSimpleName(), message.toString());
            ...
            log.error("[{}] Error processing message of WhatsApp: {}", this.getClass().getSimpleName(), e.getMessage());
