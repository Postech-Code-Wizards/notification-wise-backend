...
public class EmailConsumerUseCase {
    ...
    public void execute(StreamMessage message) {
        ...
        try {
            ...
            log.info("[{}] Received message of Email: {}", this.getClass().getSimpleName(), message.toString());
            ...
            log.error("[{}] Error processing message of Email: {}", this.getClass().getSimpleName(), e.getMessage());
